\documentclass[24pt]{scrartcl} %different doc type than normal because of layout
...
\begin{landscape}
	...
	\pagestyle{empty}
		...
		\begin{minipage}[c]{7.2in}%
			...
			{\large\bfseries\color{MediumTurquoise}{Employee of the Month}}\\
		...
		{Employee Name}}} for outstanding customer service and record monthly sales at 
		\emph{\color{LightSlateGrey} {XYZ Sales Company}} on this day, {Today's Date}.
		}
		\end{center}
		%
		\vskip1.5em
