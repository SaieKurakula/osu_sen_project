<?php
	...
	$result = $mysqli->query('SELECT CONCAT(users.lastname, ", ", users.firstname) AS user, COUNT(award_record.award_record_ID) AS award_count FROM users INNER JOIN award_record ON users.id=award_record.usr_ID GROUP BY user');
...
<html>
	...
	<body>
		...
		<div id="barchart" style="width: 1200px; height: 800px;"></div>
	</body>
</html>