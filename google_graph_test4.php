<?php
	...
	$result = $mysqli->query('SELECT MONTHNAME(award_record.award_create_date) AS award_month, COUNT(award_record.award_record_ID ) AS award_count FROM award_record GROUP BY award_month');
